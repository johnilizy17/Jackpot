                      ...
                      {fetch.map((a, b) => (
                          ...
                          <td scope="row" data-label="id">{formatEther(a.id) * 1000000000000000000}</td>
                           <td data-label="Jackpot Name">${formatEther(a.name) * 1000000000000000000}</td>
                               <td data-label="Winneer Address">{formatEther(a.winner)}</td>
                                <td data-label="Date">${formatEther(a.endtime) * 1000000000000000000}</td>
                               <td data-label="Status">{formatEther(a.winner) === address? "You lost" : "You won"}</td>
