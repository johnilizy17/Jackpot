                ...
                <Box mt="20px">
                    ...
                    <Flex flexWrap="wrap" flexDir='column'>
                       ...
                       { type != 1? 
                        ...
                        <Box mr="10px" mt="10px">2. {jackpotData[1] && jackpotData[8].result && formatEther(jackpotData[8].result)}% NEXT BIG JACKPOT</Box>
                       }
                      <Box mr="10px" mt="10px">2. 35% Alpha Vault</Box>
                       <Box mr="10px" mt="10px">3. {jackpotData[2] && jackpotData[8].result && formatEther(jackpotData[2].result) * 1000000000000000000}% MARKETING</Box>
                        <Box mr="10px" mt="10px">4. {jackpotData[1] && jackpotData[8].result && formatEther(jackpotData[9].result)}% BOMB PRIZ</Box>
                    </Flex>
                </Box>
            </Box>
            <footer class="footer">
