        ...
        <>
            ...
            <Box>
                <section className="page">
                    <Box className="body">
                        <Box className="timer">
                            <TimeCounter setStartTimer={setStartTimer} name={name} startTimer={startTimer} timeRefresh={timeRefresh} date={date} DownDate={DownDate} setDownDate={setDownDate} setLoading2={setLoading2} setDisable={setDisable} setName={setName} setDate={setDate} type={type} />
                        </Box>
