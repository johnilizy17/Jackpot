  ...
  return (
   <>
    <Flex  justifyContent="center" pos="relative" mt='50px'>
        <Box pos="absolute"  w='70%' left={0} top={0} h='30rem'><Img src="../image/blur.svg" h='100%' objectFit="contain"/></Box>
      <Box w={['100%', '80%', null, '60%']}  bg='#4D46B9' boxShadow='lg' p={["30px 30px", "30px 40px", null, "30px 80px"]}>
